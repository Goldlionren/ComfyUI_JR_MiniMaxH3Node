...
EXPECTED = {
    "JR_H3_OpenAICompatiblePromptOptimizer", "JR_H3_RTXUpscalerRefiner",
...
def test_modules_import_individually(package_name):
    for name in ["h3_openai_prompt_optimizer", "rtx_upscaler_refiner", "resolution_scale_calculator", "enhanced_video_combine", "last_frame"]:
