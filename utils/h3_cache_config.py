...
_BASE_PRESETS = {
    "visual_fast": dict(start_percent=0.06, end_percent=0.94, warmup_steps=2, front_blocks=1, back_blocks=1,
                        video_threshold=0.035, audio_threshold=0.025, fast_path_threshold=0.012,
                        probe_path_threshold=0.055, max_full_step_hits=3, max_block_hits=2,
    ...
    "dialogue_safe": dict(start_percent=0.12, end_percent=0.88, warmup_steps=3, front_blocks=1, back_blocks=2,
                          video_threshold=0.018, audio_threshold=0.010, fast_path_threshold=0.006,
                          probe_path_threshold=0.025, max_full_step_hits=0, max_block_hits=1,
    ...
    "action_safe": dict(start_percent=0.15, end_percent=0.85, warmup_steps=3, front_blocks=2, back_blocks=2,
                        video_threshold=0.012, audio_threshold=0.010, fast_path_threshold=0.004,
                        probe_path_threshold=0.018, max_full_step_hits=0, max_block_hits=1,
    ...
    "balanced": dict(start_percent=0.10, end_percent=0.90, warmup_steps=2, front_blocks=1, back_blocks=2,
                     video_threshold=0.020, audio_threshold=0.012, fast_path_threshold=0.008,
